        ...
        <div class="wel-grids">
            <div class="col-md-4 wel-grid">
                <div class="port-7 effect-2">
                    <div class="image-box">
                        <img src="{{asset('/')}}images/w1.jpg" class="img-responsive" alt="Image-2">
                    </div>
                    <div class="text-desc">
                        <h4>Studies</h4>
                    </div>
                ...
                <div class="port-7 effect-2">
                    <div class="image-box">
                        <img src="{{asset('/')}}images/w2.jpg" class="img-responsive" alt="Image-2">
                    </div>
                    <div class="text-desc">
                        <h4>Studies</h4>
                    </div>
            ...
            <div class="col-md-4 wel-grid">
                <img src="{{asset('/')}}images/w3.jpg"  class="img-responsive" alt="Image-2">
                <div class="text-grid">
                    <h4>Studies</h4>
                </div>
            </div>
            <div class="col-md-4 wel-grid">
                <div class="port-7 effect-2">
                    <div class="image-box">
                        <img src="{{asset('/')}}images/w4.jpg" class="img-responsive" alt="Image-2">
                    </div>
                    <div class="text-desc">
                        <h4>Studies</h4>
                    </div>
                ...
                <div class="port-7 effect-2">
                    <div class="image-box">
                        <img src="{{asset('/')}}images/w5.jpg" class="img-responsive" alt="Image-2">
                    </div>
                    <div class="text-desc">
                        <h4>Studies</h4>
                    </div>
...
<div class="student-w3ls">
    <div class="container">
        ...
        <div class="student-grids">
            ...
            <div class="col-md-6 student-grid">
                <img src="{{asset('/')}}images/w6.jpg" class="img-responsive" alt="Image-2">
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
